...
template<> FieldBeginString::ValueType FIXPP_MSG_CLASS::get<FieldBeginString>() const { return getBeginString(); }
template<> FieldBodyLength::ValueType FIXPP_MSG_CLASS::get<FieldBodyLength>() const { return getBodyLength(); }
template<> FieldMsgType::ValueType FIXPP_MSG_CLASS::get<FieldMsgType>() const { return getMsgType(); }
template<> FieldSenderCompID::ValueType FIXPP_MSG_CLASS::get<FieldSenderCompID>() const { return getSenderCompID(); }
template<> FieldTargetCompID::ValueType FIXPP_MSG_CLASS::get<FieldTargetCompID>() const { return getTargetCompID(); }
template<> FieldMsgSeqNum::ValueType FIXPP_MSG_CLASS::get<FieldMsgSeqNum>() const { return getMsgSeqNum(); }
template<> FieldSendingTime::ValueType FIXPP_MSG_CLASS::get<FieldSendingTime>() const { return getSendingTime(); }
...
template<> FieldExecType::ValueType FIXPP_MSG_CLASS::get<FieldExecType>() const { return getExecType(); }
template<> FieldOrdStatus::ValueType FIXPP_MSG_CLASS::get<FieldOrdStatus>() const { return getOrdStatus(); }
template<> FieldOrdRejReason::ValueType FIXPP_MSG_CLASS::get<FieldOrdRejReason>() const { return getOrdRejReason(); }
template<> FieldAccount::ValueType FIXPP_MSG_CLASS::get<FieldAccount>() const { return getAccount(); }
template<> FieldSymbol::ValueType FIXPP_MSG_CLASS::get<FieldSymbol>() const { return getSymbol(); }
template<> FieldSecurityID::ValueType FIXPP_MSG_CLASS::get<FieldSecurityID>() const { return getSecurityID(); }
...
template<> FieldLastQty::ValueType FIXPP_MSG_CLASS::get<FieldLastQty>() const { return getLastQty(); }
template<> FieldLastPx::ValueType FIXPP_MSG_CLASS::get<FieldLastPx>() const { return getLastPx(); }
template<> FieldLeavesQty::ValueType FIXPP_MSG_CLASS::get<FieldLeavesQty>() const { return getLeavesQty(); }
template<> FieldAvgPx::ValueType FIXPP_MSG_CLASS::get<FieldAvgPx>() const { return getAvgPx(); }
template<> FieldCumQty::ValueType FIXPP_MSG_CLASS::get<FieldCumQty>() const { return getCumQty(); }
